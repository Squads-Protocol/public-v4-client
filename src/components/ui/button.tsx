  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium:
          "bg-gradient-to-r from-primary via-purple-500 to-primary bg-[length:200%_100%] text-primary-foreground shadow-md shadow-primary/25 hover:shadow-lg hover:shadow-primary/30 hover:bg-[position:100%_0] active:scale-[0.98] transition-all duration-300",
        success:
          "bg-green-600 text-white shadow-sm hover:bg-green-600/90 hover:shadow-md hover:shadow-green-500/20 active:scale-[0.98]",
      },
      size: {
